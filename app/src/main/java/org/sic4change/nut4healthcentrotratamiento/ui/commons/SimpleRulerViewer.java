...
public class SimpleRulerViewer extends View implements
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onChange(SimpleRulerViewer view, int position, float value);
    }

    /**
     * Constructor that is called when inflating SimpleRulerViewer from XML
     *
     * @param context
     * @param attrs
     */
    public SimpleRulerViewer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    /**
     * simple constructor to use when creating a SimpleRulerViewer from code
     *
     * @param context
     */
    public SimpleRulerViewer(Context context) {
        this(context, null);
    }
    ...
    private void fling(int velocityX) {
        mScroller.fling(getScrollX(), 0, velocityX , 0,
