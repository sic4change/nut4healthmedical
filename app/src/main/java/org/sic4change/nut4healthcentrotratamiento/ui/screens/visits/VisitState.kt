...
fun rememberVisitsState(
    ...
    selectedVitamineAVaccinated, expandedVitamineAVaccinated, selectedCapsulesFerro, expandedCapsulesFerro, amoxicilina, othersTratments, selectedCartilla, expandedCartilla,
