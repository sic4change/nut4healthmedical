...
class NUT4HealthAppState(
    ...
    companion object {
        val DRAWER_OPTIONS = listOf(NavItem.NEXT_VISITS, NavItem.TUTORS, NavItem.REFERENCES, NavItem.TRANSFERENCES, NavItem.SETTINGS)
        val BOTTOM_NAV_OPTIONS = listOf(NavItem.NEXT_VISITS, NavItem.TUTORS,  NavItem.REFERENCES, NavItem.TRANSFERENCES, NavItem.SETTINGS)
    }
